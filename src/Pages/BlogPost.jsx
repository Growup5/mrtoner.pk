...
const BlogPost = () => {
  ...
  const printers = [
    ...
    },
    {
      ...
      description: 'While not a printer, this premium device shows our card design capabilities. The Dyson Pure Cool Link purifies while cooling, with HEPA filtration and smart connectivity.',
      features: ['HEPA filtration', 'Wi-Fi connected', 'Air multiplier technology', 'Night-time mode', 'Auto mode'],
      price: 499,
      rating: 4.8,
      reviews: 215,
      type: 'other',
      bestFor: 'home',
      tags: ['smart', 'premium', 'air-purifier'],
      link: '/products/dyson-pure-cool',
      icon: <FiPrinter className="text-2xl" />,
      image: 'https://images.unsplash.com/photo-1553787764-682bc8f9d8e1?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80',
      specialBadge: 'SMART DEVICE'
    }
  ];
